          ...
          <el-card class="box-card">
            ...
            <el-card class="box-card">
              ...
              <el-row :gutter="10">
                ...
                <!-- 运行按钮 -->
                <el-col :span="2">
                  <el-button type="primary" icon="el-icon-upload el-icon--left">保存</el-button>
                </el-col>
              </el-row>
                  ...
                  <el-row :gutter="20" v-for='(header,index) in caseInfo.headers' :key='index' style="margin: 10px;">
                    ...
                    <el-col :span="6">
                      <el-button type="danger" icon="el-icon-delete"
                                 @click='deleteInputRow(header,"headers")'></el-button>
                    </el-col>
                  </el-row>
                </el-tab-pane>
                <!-- 请求参数 -->
                  ...
                  <el-tabs>
                    ...
                    <el-tab-pane label="Params">
                      <el-row :gutter="20" v-for='(par,index) in caseInfo.params' :key='index' style="margin: 10px;">
                        ...
                        <el-col :span="6">
                          <el-button type="danger" icon="el-icon-delete"
                                     @click='deleteInputRow(par,"params")'></el-button>
                        </el-col>
                      </el-row>
                    ...
                    <el-tab-pane label="application/X-www-urlencoded">
                      <el-row :gutter="20" v-for='(val,index) in caseInfo.data' :key='index' style="margin: 10px;">
                        ...
                        <el-col :span="6">
                          <el-button type="danger" icon="el-icon-delete"
                                     @click='deleteInputRow(val,"data")'></el-button>
                        </el-col>
                      </el-row>
