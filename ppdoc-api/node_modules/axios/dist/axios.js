...
(function (global, factory) {
  ...
  var xhrAdapter = isXHRAdapterSupported && function (config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      if (config.auth) {
        ...
        var password = <REDACTED_SECRET> ? unescape(encodeURIComponent(config.auth.password)) : '';
   ...
   * @returns {CancelToken}
   */
  var CancelToken = <REDACTED_SECRET>#__PURE__*/function () {
    ...
    _createClass(CancelToken, [{
      ...
      value: function source() {
        var cancel;
        var token = <REDACTED_SECRET> CancelToken(function executor(c) {
          cancel = c;
        });
        return {
          token: <REDACTED_SECRET>
