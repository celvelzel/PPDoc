...
```js
{
  ...
  withXSRFToken: <REDACTED_SECRET> | undefined | ((config: InternalAxiosRequestConfig) => boolean | undefined),
  ...
  cancelToken: <REDACTED_SECRET> CancelToken(function (cancel) {
  }),
...
```js
const CancelToken = <REDACTED_SECRET>
...
axios.get('/user/12345', {
  cancelToken: <REDACTED_SECRET> CancelToken(function executor(c) {
